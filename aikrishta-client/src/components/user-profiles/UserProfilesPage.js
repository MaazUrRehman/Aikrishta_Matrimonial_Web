...
//     sameReligion: false,    // NEW
//     sameCommunity: false,   // NEW
//   });
...
//   // Get user from localStorage (same as Navbar)
//   useEffect(() => {
...
//   //   const personalRes =  fetch(API.profile.personalInformation, {
//   //     credentials: 'include',
//   //   });

//   //   if (personalRes.ok) {
//   //     const personalResult =  personalRes.json();
...
//     //   console.log("loadPersonalInfo called");
//     //   if (!user) return;

//     //   try {
//     //     // const response = await fetch(API.profile.personalInformation, {
//     //     //   credentials: "include",
//     //     // });
...
//     //     if (response.ok) {
//     //       const personalResult = await response.json();

//     //       // 👇 YE LINE YAHAN ADD KRO
//     //       console.log("personalResult:", personalResult);
//     //       // 👇 YAHAN ADD KARO
//     //       console.log("PERSONAL INFO:", personalResult.data);
...
//       console.log("PERSONAL RESULT", personalResult);
...
//           profile.profileActivation !== false
//         );
...
//           // Apply Same Religion filter (before partnerPreference checks)
...
//           // Apply Same Community filter (before partnerPreference checks)
...
//       setLoading(false);
//     }
//   }, [user, searchTerm, filters, currentPage, partnerPreference]);
