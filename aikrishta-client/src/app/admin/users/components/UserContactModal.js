// // src/app/admin/users/components/UserContactModal.js
// 'use client';

// import { COLORS, TYPOGRAPHY, SPACING, BORDER_RADIUS, SHADOWS } from '@/constants/theme';

// export default function UserContactModal({ isOpen, onClose, data, userId }) {
...
//     { label: 'Monthly Income', value: data?.monthly_income ? `$${data.monthly_income.toLocaleString()}` : null },
//   ];
...
//             <h2 style={styles.title}>Contact & Professional</h2>
//           </div>
...
//                       <div key={index} style={styles.infoItemFull}>
//                         <span style={styles.label}>{field.label}</span>
//                         <span style={styles.value}>{field.value || 'N/A'}</span>
//                       </div>
//                     ))}
...
//               <p style={styles.noData}>No contact & professional information found.</p>
