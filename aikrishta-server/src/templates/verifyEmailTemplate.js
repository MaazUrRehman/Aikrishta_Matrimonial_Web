// src/templates/verifyEmailTemplate.js
...
const verifyEmailTemplate = (fullName, verificationUrl) => {
  return `
    ...
    <head>
      ...
      <title>Verify Your Email - AIKRISHTA</title>
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <p class="message">
            Thank you for registering with AIKRISHTA! Please click the button below to verify your email address and activate your account.
          </p>
          ...
          <p class="expiry">This link expires in 10 minutes.</p>

          <div class="divider"></div>

          <p class="footer-text">
            If you didn't create an account, please ignore this email.
            <br>Your email will not be verified unless you click the link above.
          </p>
        </div>
